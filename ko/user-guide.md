...
> [참고]
> Kubernetes에서 실행되는 다양한 워크로드들 중에서 GPU가 필요치 않는 것들은 GPU 노드에 할당되지 않기를 원하는 경우 [Taint 및 Toleration 개요](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/)를 참고하세요.
